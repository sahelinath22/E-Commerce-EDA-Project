...
2. Which categories and sub-categories generate the most revenue?

3. Which products or regions are causing losses and need strategic attention?

4. How do sales and profit trends vary across months and years?

5. What is the role of customer segments, shipping modes, and order priorities?

6. How can profitability be improved through pricing, discounting, and supply chain optimization?
...
2. Customer Details: Customer Name, Segment

3. Product Details: Category, Sub-Category, Product Name

4. Geographical Data: Country, City, State, Region
...
Analyzed year-over-year growth in revenue.
...
Sub-categories like Phones, Chairs, Binders led in sales.
...
Faster ship modes improved customer experience but increased cost.
...
B) Most profitable sub-categories: Phones, Accessories

C) Worst performing sub-category: Tables (negative profit)

D) Top-performing regions: West, East

E) High-revenue states: California, Washington, New York

F) Growth pattern:

Sales increased year-over-year

Profit fluctuated due to discount policies and rising costs
...
✅Regional and product-level performance patterns
